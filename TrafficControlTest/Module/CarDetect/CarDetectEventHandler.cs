...
{
	class CarDetectEventHandler : ICollisionEventHandler
	{
		...
		public CarDetectEventHandler(ICollisionEventManager CollisionEventManager, IVehicleControlManager VehicleControlManager, IVehicleInfoManager VehicleInfoManager)
		{
