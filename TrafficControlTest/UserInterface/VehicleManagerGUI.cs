...
namespace TrafficControlTest.UserInterface
{
	public partial class VehicleManagerGUI : Form
	{
		...
		private void Constructor_VehicleManagerGUI()
		{
			...
			ucAbout1.Set("Vehicle Manager", $"v{System.IO.File.GetLastWriteTime(System.Reflection.Assembly.GetExecutingAssembly().Location).ToString("yy.MM.dd")}", mCore.mProjectType, "Copyright (C) 2022 CASTEC International Corp.");
